		...
		return (
			<li className={this.props.status} style={this.props.styles}>
				<div className="view">
	              ...
	              <label onDoubleClick={this.handleEdit.bind(this, this.props.id)}>{this.props.id}</label>
	              <button className="destroy" onClick={this.handleDestroy.bind(this, this.props.id)}></button>
	            </div>
	            <input className="edit" value={this.props.id} onKeyPress={this.handleEnter.bind(this, this.props.id)} onChange={this.handleTaskChange.bind(this, this.props.id)} onBlur={this.handleBlur.bind(this, this.props.id)}/>
			</li>
		);
	}
}
